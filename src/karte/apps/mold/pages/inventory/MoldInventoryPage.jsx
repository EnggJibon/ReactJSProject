...
import {addSearchCondition, clearSearchCondition, autoSearch} from 'karte/apps/mold/reducers/mold-inventory-reducer';
import SearchConditions from 'karte/shared/logics/search-conditions';

class MoldInventoryPage extends React.Component {
  /**
   * コンストラクタ
   * @param {*} props 
   */
  constructor(props) {
    ...
    this.state = {
      dict: {
        ...
        sp_mold_inventory: '',
        next: '',
        msg_sp_mold_inventory_search_explanation: '',
        sp_mold_inventory_search_cond_not_done: '',
        company_name: '',
        location_name: '',
  ...
  createPickerCompany(setDefault) {
    ...
    //Pickerオブジェクト作成
    me.pickerCompany = me.createPicker('#mold-inventory-page-picker-company', _values, _displayValues,
      //Col Change Callback
  ...
  createPickerLocation() {
    ...
    me.pickerLocation = me.createPicker('#mold-inventory-page-picker-location', _values, _displayValues, 
      //Col Change Callback
      (picker, value, displayValue) => {
  ...
  createPickerOwnerCompany() {
    ...
    //Pickerオブジェクト作成
    me.pickerOwnerCompany = me.createPicker('#mold-inventory-page-picker-owner-company', _values, _displayValues,
      //Col Change Callback
      (picker, value, displayValue) => {
  ...
  createPickerDepartment(setDefault) {
    ...
    me.pickerDepartment = me.createPicker('#mold-inventory-page-picker-department', _values, _displayValues, 
      //Col Change Callback
      (picker, value, displayValue) => {
  ...
  createPickerInstallationSite() {
    ...
    me.pickerInstallationSite = me.createPicker('#mold-inventory-page-picker-installation-site', _values, _displayValues, 
      //Col Change Callback
      (picker, value, displayValue) => {
  ...
  handleNextButton() {
    ...
    this.props.addSearchCondition({
      ...
      department: this.state.departmentId === '' || this.state.department === undefined ? 0 : parseInt(this.state.departmentId),
    ...
    this.$f7.views.main.router.navigate(APP_DIR_PATH + '/mold-inventory-result', {pushState:false, reloadAll: true});
  }
    ...
    if(scSet >= searchCondList.length){
      var timeInterval = setInterval(() => {
        if(me.$f7router.allowPageChange){
          ...
          this.pressedNext = true;
          me.$f7.views.main.router.navigate(APP_DIR_PATH + '/mold-inventory-result', {pushState:false, reloadAll: true});
        }
      }, 100);
      return;
    } else {
      ...
      <DocumentTitle title={this.state.dict.sp_mold_inventory}>
        <Page onPageInit={this.onPageInit.bind(this)} onPageBeforeRemove={this.onPageBeforeRemove.bind(this)} onPageBeforeOut={this.onPageBeforeOut.bind(this)}>
          ...
          <Block className="no-margin-top no-margin-bottom">
            <p>{this.state.dict.msg_sp_mold_inventory_search_explanation}</p>
          </Block>
          <List className="no-margin-top no-margin-bottom">
            <ListItem>
              <Label>{this.state.dict.company_name + this.state.required}</Label>
              <Input type="text" name="companyId" clearButton readonly inputId="mold-inventory-page-picker-company"
            ...
            <ListItem>
              ...
              <Input type="text" name="locationId" clearButton readonly inputId="mold-inventory-page-picker-location" 
            ...
            <ListItem>
              ...
              <Input type="text" name="installationSiteId" clearButton readonly inputId="mold-inventory-page-picker-installation-site" 
          ...
          <List className="no-margin-top no-margin-bottom">
            <ListItem>
              <Label>{this.state.dict.moldDepartment}</Label>
              <Input type="text" name="departmentId" clearButton readonly inputId="mold-inventory-page-picker-department" 
            ...
            <ListItem>
              ...
              <Input type="text" name="ownerCompanyId" clearButton readonly inputId="mold-inventory-page-picker-owner-company" 
          ...
          <Block className="smallMargin">
            <Row>
              <Col>
                ...
                </Checkbox> {this.state.dict.sp_mold_inventory_search_cond_not_done}
              </Col>
            </Row>
          </Block>
          <Block className="smallMargin">
...
function mapStateToProps(state) {
  return {
    ...
    //continueSearch: state.mold.moldInventory.continueSearch
