...
export default class MachineMainteStartPage extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      dict: {
  ...
  render() {
    return (
      <DocumentTitle title={this.state.dict.sp_machine_maintenance}>
        <Page>
          ...
          <BlockTitle>{this.state.dict.sp_machine_maintenance}</BlockTitle>
          <List>
            <ListItem key={1} link={APP_DIR_PATH + '/machine-mainte-start'} title={this.state.dict.sp_machine_maintenance_start}></ListItem>
            <ListItem key={2} link={APP_DIR_PATH + '/machine-mainte-recommend'} title={this.state.dict.sp_regular_maintenance_proposal_list}></ListItem>
            <ListItem key={3} link={APP_DIR_PATH + '/machine-mainte-end'} title={this.state.dict.sp_machine_maintenance_end}></ListItem>
          </List>
        </Page>
      </DocumentTitle>
    );
